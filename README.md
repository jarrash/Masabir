![Masabir logo](misc/images/docs/masabir_logo.svg?raw=true)
...
Masabir is a flexible solution that can monitor anything from a simple, standalone application to a large-scale environment, with features including:
...
- **Unparalleled flexibility:** Adapt Masabir to your needs and utilize built-in functionalities, including the ability to stream metrics and events over HTTP, reporting, auditing, security, service SLA calculations, and many more.

## Get started

- [Get Masabir](https://www.masabir.com/download)
- [Installation manual](https://docs.masabir.com/manual/installation)

## Documentation

Masabir documentation is available at [docs.masabir.com](https://docs.masabir.com/)

## License

Masabir is distributed under [AGPL-3.0-only](COPYING)
